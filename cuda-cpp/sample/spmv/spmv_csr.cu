...
#ifdef FLOAT
        cusparseScsrmv(cusparseHandle, CUSPARSE_OPERATION_NON_TRANSPOSE, mat.nrow, mat.ncolumn,
                       mat.nnz, &alpha, descr, mat.d_values, mat.d_rpt, mat.d_colids, d_x, &beta,
                       d_y);
#else
        cusparseDcsrmv(cusparseHandle, CUSPARSE_OPERATION_NON_TRANSPOSE, mat.nrow, mat.ncolumn,
                       mat.nnz, &alpha, descr, mat.d_values, mat.d_rpt, mat.d_colids, d_x, &beta,
                       d_y);
#endif
